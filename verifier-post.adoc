...
----
include::https://raw.githubusercontent.com/spring-cloud/spring-cloud-contract/master/samples/standalone/http-client/src/test/java/com/example/loan/LoanApplicationServiceTests.java[tags=client_tdd,indent=0]
----
...
Let's assume that you have hardcoded the port of the collaborator at `8080` and your application is running on `8090`. If you'd start your integration tests and sent that request you'd obviously had a broken test since you have no service running on port `8080`.
...
Play around with the contract until your happy with its content. Once you're ready to check the API in practice in your integration tests just install the stubs locally

*add the Spring Cloud Contract Verifier plugin*

You can add either Maven or Gradle plugin - in this example we'll show how to add Maven. First add the `Spring Cloud Contract` BOM.

[source,xml,indent=0]
----
include::https://raw.githubusercontent.com/spring-cloud/spring-cloud-contract/master/samples/standalone/http-server/pom.xml[tags=contract_bom,indent=0]
----
...
[source,xml,indent=0]
----
include::https://raw.githubusercontent.com/spring-cloud/spring-cloud-contract/master/samples/standalone/http-server/pom.xml[tags=contract_maven_plugin,indent=0]
----
...
It's confirming that the stubs of the `http-server` have been installed in your local repository.
...
[source,xml,indent=0]
----
include::https://raw.githubusercontent.com/spring-cloud/spring-cloud-contract/master/samples/standalone/http-client/pom.xml[tags=contract_bom,indent=0]
----
...
[source,xml,indent=0]
----
include::https://raw.githubusercontent.com/spring-cloud/spring-cloud-contract/master/samples/standalone/http-client/pom.xml[tags=stub_runner,indent=0]
----
...
----
include::https://raw.githubusercontent.com/spring-cloud/spring-cloud-contract/master/samples/standalone/http-client/src/test/resources/application.yaml[tags=stubs,indent=0]
----
...
[source,groovy,indent=0]
----
include::https://raw.githubusercontent.com/spring-cloud/spring-cloud-contract/master/samples/standalone/http-client/src/test/java/com/example/loan/LoanApplicationServiceTests.java[tags=autoconfigure_stubrunner,indent=0]
----
...
Which means that Stub Runner has found your stubs and started a server for app with group id `com.example`, artifact if `http-server` with version `0.0.1-SNAPSHOT` of the stubs and with `stubs` classifier on port `8080`.

*file a PR*

When you're happy with the contract and your test passes publish a PR to the server side. Currently your work is done.
...
[source,xml,indent=0]
----
include::https://raw.githubusercontent.com/spring-cloud/spring-cloud-contract/master/samples/standalone/http-server/pom.xml[tags=verifier_test_dependencies,indent=0]
----
...
Now you can disable the offline work for Spring Cloud Contract Stub Runner ad provide where the repository with your stubs is placed. At this moment the stubs of the server side will be automatically downloaded from Nexus / Artifactory. Just uncomment the following line:

[source,yaml,indent=0]
----
include::https://raw.githubusercontent.com/spring-cloud/spring-cloud-contract/master/samples/standalone/http-client/src/test/resources/application.yaml[tags=repo_root,indent=0]
----
